...
export const CATEGORIES: CategoryInfo[] = [
  {
    ...
    icon: 'PlaneLanding',
    image: 'public\\images\\categories\\Avions de Ligne.jpg'
  },
  {
    id: 'Combat Aircraft',
    ...
    icon: 'Shield',
    image: 'public/images/categories/Avions de Combat.webp'
  },  
  {
    ...
    icon: 'Truck',
    image: 'public\\images\\categories\\Combat Support Aircraft.jpg'
  },
  {
    ...
    icon: 'GraduationCap',
    image: 'public\\images\\categories\\Combat Training Aircraft.jpg'
  },
  {
    ...
    icon: 'Wind',
    image: 'public\\images\\categories\\Avions de Ligne Turbopropulsés.jpg'
  },
  {
    id: 'Civil Utility',
    ...
    icon: 'AlertCircle',
    image: 'public\\images\\categories\\Avions de Rôle Spécialisé.jpg'
  },
  {
    ...
    icon: 'Crown',
    image: 'public\\images\\categories\\Avions d\'Affaires.avif'
  },
  {
    ...
    icon: 'Feather',
    image: 'public\\images\\categories\\Avions Légers Privés.jpg'
  },
  {
    id: 'Helicopters',
    title: 'Hélicoptères',
    ...
    icon: 'Zap',
    image: 'public\\images\\categories\\Hélicoptères.jpg'
  },
  {
    ...
    icon: 'Radar',
    image: "public\\images\\categories\\Drones & UAV.jpg"
  }
];
...
,
  ...
  },
  {
    ...
    recognitionTips: [
      ...
      "Flotteurs latéraux massifs"
    ],
    description: "Version construite sous licence du Sikorsky SH-3 Sea King, pilier des opérations navales de sauvetage et de lutte ASM.",
...
,
  ...
  },
  {
    ...
    recognitionTips: [
      "Aile basse et droite",
      "Deux turboréacteurs montés à l'arrière",
      "Empennage en croix (mid-mounted tail)"
    ],
    description: "Issu du Citation I, le Citation II dispose d'un fuselage allongé d'une section supplémentaire. 733 appareils ont été construits.",
    specs: { wingspan: '15,9 m', length: '14,4 m', height: '4,6 m', payload: '1 406 kg' }
  },
  {
    id: 'citation-iii',
    name: 'Cessna 650 Citation III',
    ...
    enginesCount: 2,
    recognitionTips: [
      "Première conception de Citation à aile en flèche",
      "Empennage en T",
      "Moteurs à l'arrière"
    ],
    description: "Le Citation III a marqué un tournant avec ses ailes en flèche. Les versions VI (bas coût) et VII (moteurs plus puissants) lui sont très similaires visuellement.",
    specs: { wingspan: '16,3 m', length: '16,9 m', height: '5,1 m', payload: '1 583 kg' }
  },
  {
    id: 'citation-v',
    name: 'Cessna 560 Citation V',
    ...
    enginesCount: 2,
    recognitionTips: [
      "Aile basse et droite avec emplantures de bord d'attaque en flèche",
      "Sept fenêtres de cabine",
      "Moteurs à l'arrière"
    ],
    description: "Développement du Citation S/II, le Citation V a été rallongé de 0,5 m et possède une septième fenêtre de cabine caractéristique.",
    specs: { wingspan: '15,9 m', length: '14,9 m', height: '4,6 m', payload: '2 132 kg' }
  },
  {
    id: 'citation-x',
    name: 'Cessna 750 Citation X',
    category: 'Private Executive Aircraft',
    role: 'Jet d\'affaires long-courrier à haute vitesse',
    manufacturer: 'Cessna',
    country: 'USA',
    engineType: 'Jet',
    enginesCount: 2,
    recognitionTips: [
      "Aile basse avec une flèche très prononcée",
      "Double empennage en T très incliné",
      "Moteurs imposants à l'arrière"
    ],
    description: "Apparu en 1994, c'est une version très améliorée de la famille Citation III. Ses moteurs Allison puissants lui confèrent des vitesses de croisière très élevées.",
    specs: { wingspan: '19,5 m', length: '22 m', height: '5,8 m', payload: '3 000 kg' }
  },
  {
    id: 'falcon-50',
    name: 'Dassault Falcon 50',
    ...
    enginesCount: 3,
    recognitionTips: [
      "Trois turboréacteurs à l'arrière",
      "Entrée d'air en S pour le moteur central",
      "Aile basse en flèche"
    ],
    description: "L'un des jets d'affaires les plus coûteux lors de sa sortie, offrant la sécurité d'un troisième moteur pour les traversées océaniques ou désertiques.",
    specs: { wingspan: '18,9 m', length: '18,5 m', height: '6,9 m', payload: '2 170 kg' }
  },
  {
    id: 'falcon-100',
    name: 'Dassault Falcon 100',
    category: 'Private Executive Aircraft',
    role: 'Jet d\'affaires court-courrier',
    manufacturer: 'Dassault',
    country: 'France',
    engineType: 'Jet',
    enginesCount: 2,
    recognitionTips: [
      ...
      "Quatre fenêtres de cabine sur le côté tribord"
    ],
    description: "Évolution du Falcon 10 original, le Falcon 100 possède une masse maximale au décollage plus élevée et une fenêtre supplémentaire par rapport au modèle initial.",
    specs: { wingspan: '13,1 m', length: '13,8 m', height: '4,6 m', payload: '1 305 kg' }
  },
  {
    id: 'falcon-200',
    name: 'Dassault Falcon 200',
    ...
    recognitionTips: [
      "Aile basse en flèche",
      "Deux turboréacteurs à l'arrière",
      "Empennage horizontal monté à mi-hauteur de la dérive"
    ],
    description: "Successeur du Falcon 20, il intègre de nouveaux moteurs et une autonomie accrue. Très utilisé par les garde-côtes américains sous le nom HU-25 Guardian.",
    specs: { wingspan: '16,3 m', length: '17,2 m', height: '5,3 m', payload: '1 265 kg' }
  },
  {
    id: 'falcon-900',
    name: 'Dassault Falcon 900',
    ...
    recognitionTips: [
      "Trois turboréacteurs à l'arrière",
      "Fuselage plus large et plus long que le Falcon 50",
      "Nombreuses fenêtres de cabine"
    ],
    description: "Développement de la lignée Falcon 50, il est l'un des transports de luxe les plus chers et les plus rapides de sa catégorie.",
    specs: { wingspan: '19,3 m', length: '20,2 m', height: '7,5 m', payload: '1 385 kg' }
  },
  {
    id: 'xingu',
    name: 'EMBRAER EMB-121 Xingu',
  ...
  },
  {
    ...
    description: "Basé sur le Rockwell Jet Commander, la production a été déplacée en Israël en 1968. La version Sea Scan est utilisée pour la patrouille maritime.",
    specs: { wingspan: '13,6 m', length: '15,9 m', height: '4,8 m', payload: '1 496 kg' }
  },
  {
    id: 'astra',
    name: 'IAI 1125 Astra',
    category: 'Private Executive Aircraft',
    role: 'Transport d\'affaires long-courrier',
    manufacturer: 'IAI',
    country: 'Israël',
    engineType: 'Jet',
    enginesCount: 2,
    recognitionTips: [
      "Aile basse étroite et en flèche",
      "Empennage horizontal monté à mi-hauteur",
      "Fuselage profilé"
    ],
    description: "Évolution du Westwind, l'Astra a été redessiné pour de meilleures performances à haute altitude. IAI a lancé une version améliorée nommée Galaxy.",
    specs: { wingspan: '16 m', length: '16,9 m', height: '5,5 m', payload: '1 259 kg' }
  },
  {
    id: 'learjet-23-29',
    name: 'Learjet 23-29',
    ...
    recognitionTips: [
      "Aile basse et droite",
      "Réservoirs de bout d'aile imposants",
      "Empennage en T en flèche"
    ],
    description: "L'un des pionniers du jet d'affaires. On distingue les variantes (23, 24, 25, 28, 29) principalement par le nombre de fenêtres de cabine.",
    specs: { wingspan: '10,8 m', length: '13,2 m', height: '3,7 m', payload: '1 755 kg' }
  },
  {
    id: 'learjet-35-36',
    name: 'Learjet 35/36',
    ...
    enginesCount: 2,
    recognitionTips: [
      "Nacelles moteurs plus grandes que les séries 20",
      "Réservoirs en bout d'aile",
      "Empennage en T"
    ],
    description: "Redessiné en 1973 avec un fuselage étiré. Plusieurs versions militaires existent pour la patrouille maritime, la reconnaissance ou l'entraînement à la guerre électronique.",
    specs: { wingspan: '12 m', length: '14,8 m', height: '3,7 m', payload: '1 534 kg' }
  },
  {
    id: 'learjet-45',
    name: 'Learjet 45',
    ...
    recognitionTips: [
      "Aile basse en flèche avec winglets",
      "Double empennage vertical sous la queue (delta fins)",
      "Empennage en T"
    ],
    description: "Conçu pour offrir une meilleure efficacité et plus d'espace intérieur que les modèles précédents. Utilise une nouvelle aile pour réduire la traînée.",
    specs: { wingspan: '14,5 m', length: '17,6 m', height: '4,3 m', payload: '2 650 kg' }
  },
  {
    id: 'learjet-55-60',
    name: 'Learjet 55/60',
    ...
    recognitionTips: [
      "Fuselage large (widebody)",
      "Aile basse et droite avec winglets",
      "Empennage en T"
    ],
    description: "Le modèle 55 a été le premier à utiliser des winglets. Il a été remplacé par le modèle 60, doté d'un espace interne encore plus vaste.",
    specs: { wingspan: '13,3 m', length: '17,9 m', height: '4,5 m', payload: '2 650 kg' }
  },
  {
    id: 'jetstar-ii',
    name: 'Lockheed Martin Jetstar II',
    ...
    enginesCount: 4,
    recognitionTips: [
      "Quatre turboréacteurs à l'arrière",
      "Larges carénages de réservoirs sur les ailes",
      "Aile basse en flèche"
    ],
    description: "Ayant volé en 1957, il a été remis en production en 1975 sous la forme Jetstar II avec une avionique et des moteurs modernes.",
    specs: { wingspan: '16,6 m', length: '18,4 m', height: '6,2 m', payload: '1 280 kg' }
  },
  {
    id: 'hansa-jet',
    name: 'MBB HFB 320 Hansa',
    ...
    enginesCount: 2,
    recognitionTips: [
      "Aile en flèche inversée (vers l'avant)",
      "Empennage en T",
      "Deux turboréacteurs à l'arrière"
    ],
    description: "Unique en raison de son aile à flèche inversée, facilitant l'identification de cet appareil rare (seulement 50 exemplaires construits).",
    specs: { wingspan: '14,5 m', length: '16,6 m', height: '4,9 m', payload: '1 600 kg' }
  },
  {
    id: 'avanti',
    name: 'Piaggio P.180 Avanti',
    ...
    enginesCount: 2,
    recognitionTips: [
      "Configuration bi-moteur propulsif (hélices vers l'arrière)",
      "Petit plan canard sur le nez (foreplane)",
      "Fuselage en forme de fuseau"
    ],
    description: "Design unique et fonctionnel où les ailes sont reculées pour libérer l'espace en cabine. Ses hélices propulsives réduisent le bruit intérieur.",
    specs: { wingspan: '14 m', length: '14,4 m', height: '3,9 m', payload: '907 kg' }
  },
  {
    id: 'chieftain',
    name: 'Piper PA-31-350 Chieftain',
    category: 'Private Executive Aircraft',
    role: 'Avion d\'affaires court-courrier',
    manufacturer: 'Piper',
    country: 'USA',
    engineType: 'Piston',
    enginesCount: 2,
    ...
    description: "Développé à partir du Navajo, il possède un fuselage plus long. Très utilisé comme taxi aérien ou pour le transport de fret léger.",
    specs: { wingspan: '12,4 m', length: '10,5 m', height: '3,9 m', payload: '159 kg' }
  },
  {
    id: 'beechjet',
    name: 'Raytheon (Beechcraft) 400A Beechjet',
    ...
    description: "Initialement le Mitsubishi Diamond II, les droits ont été rachetés par Raytheon en 1985. Utilisé par l'USAF pour l'entraînement sous le nom T-1A Jayhawk.",
    specs: { wingspan: '13,3 m', length: '14,7 m', height: '4,2 m', payload: '1 406 kg' }
  },
  {
    id: 'king-air',
    name: 'Raytheon (Beechcraft) King Air',
    category: 'Private Executive Aircraft',
    role: 'Transport d\'affaires moyen-courrier',
    manufacturer: 'Raytheon (Beechcraft)',
    country: 'USA',
    engineType: 'Turboprop',
    enginesCount: 2,
    recognitionTips: [
      "Aile basse et droite",
      "Bimoteur turbopropulsé",
      "Emplantures de bord d'attaque de l'aile en flèche"
    ],
    description: "Le Super King Air est la base de l'avion de renseignement électronique RC-12 Guardrail. Il est également utilisé pour la surveillance maritime.",
    specs: { wingspan: '16,6 m', length: '13,3 m', height: '4,6 m', payload: '680 kg' }
  },
  {
    id: 'starship',
    name: 'Raytheon (Beechcraft) Starship 1',
    ...
    enginesCount: 2,
    recognitionTips: [
      "Configuration canard (plan à l'avant)",
      "Bimoteur propulsif à l'arrière",
      "Dérives verticales en bout d'aile"
    ],
    description: "Design unique avec des hélices propulsives montées sur une aile en croissant. Les plans canards pivotent vers l'avant pour le décollage.",
    specs: { wingspan: '16,6 m', length: '14 m', height: '3,9 m', payload: '1 125 kg' }
  },
  {
    id: 'raytheon-125',
    name: 'Raytheon (BAe) 125',
  ...
  },
  {
    ...
    enginesCount: 2,
    recognitionTips: [
      "Version allongée du Hawker 800",
      "Dérive haute",
      "Deux turboréacteurs à l'arrière"
    ],
    description: "BAe a conçu cette version pour répondre aux spécifications intercontinentales. Le fuselage est plus long et la capacité en carburant augmentée.",
    specs: { wingspan: '15,7 m', length: '16,4 m', height: '5,2 m', payload: '1 043 kg' }
  },
  {
    id: 'sabreliner',
    name: 'Rockwell Sabreliner',
    ...
    description: "Conçu initialement pour un besoin de l'USAF. Le T-39 est sa version d'entraînement militaire.",
    specs: { wingspan: '13,6 m', length: '14,4 m', height: '5,3 m', payload: '2 494 kg' }
  },
  {
    id: 'starcraft-sk700',
    name: 'Starcraft SK-700',
  ...
  },
  {
    ...
    recognitionTips: [
      "Aile basse peu en flèche",
      "Deux turboréacteurs à l'arrière",
      "Empennage en T très effilé"
    ],
    description: "Ce jet séduisant a connu une histoire mouvementée. Il est désormais produit par une co-entreprise américano-taïwanaise.",
    specs: { wingspan: '11,1 m', length: '12,9 m', height: '4,2 m', payload: '1 270 kg' }
  },
  {
    id: 'vantage',
    name: 'Visionaire VA-10 Vantage',
    ...
    enginesCount: 1,
    recognitionTips: [
      "Aile en flèche inversée (médiane/avant)",
      "Un seul turboréacteur",
      "Entrées d'air sur les épaules"
    ],
    description: "Seul avion d'affaires au monde entièrement construit en matériaux composites. Son aile à flèche inversée minimise la traînée.",
    specs: { wingspan: '14,5 m', length: '12,4 m', height: 'N/A', payload: '1 000 kg' }
  },
  {
    id: 'boero-115',
    name: 'Aero Boero 115',
    ...
    recognitionTips: [
      ...
      "Dérive de forme carrée"
    ],
    description: "De conception argentine, il est très similaire au Piper Super Cub. Il remplit des rôles allant de l'entraînement au traitement agricole.",
    specs: { wingspan: '10,8 m', length: '7,1 m', height: '2,1 m', payload: '100 kg' }
  },
  {
    id: 'skyrocket',
    name: 'AviaBellanca Skyrocket',
    ...
    description: "Ayant volé en 1974, il détient cinq records du monde de vitesse dans sa catégorie.",
    specs: { wingspan: '10,7 m', length: '8,8 m', height: '2,7 m', payload: '91 kg' }
  },
  {
    id: 'viking',
    name: 'AviaBellanca Viking',
    ...
    recognitionTips: [
      "Aile basse droite",
      "Monomoteur à pistons",
      "Carénages de train d'atterrissage sous les ailes"
    ],
    description: "Plus de 1 500 Vikings ont été construits jusqu'en 1980. Le train d'atterrissage se rétracte dans deux carénages très visibles.",
    specs: { wingspan: '10,4 m', length: '8 m', height: '2,2 m', payload: '84 kg' }
  },
  {
    id: 'c152-aerobat',
    name: 'Cessna 152 Aerobat',
    ...
    description: "Version renforcée du Cessna 150/152 destinée à la voltige aérienne. Plus de 24 000 exemplaires de cette famille ont été produits.",
    specs: { wingspan: '9,9 m', length: '7,3 m', height: '2,6 m', payload: '54 kg' }
  },
  {
    id: 'c172-skyhawk',
    name: 'Cessna 172 Skyhawk',
    ...
    recognitionTips: [
      "Aile haute droite haubanée",
      "Monomoteur à pistons",
      "Quatre fenêtres latérales"
    ],
    description: "L'avion léger le plus populaire au monde avec plus de 35 000 exemplaires produits.",
    specs: { wingspan: '10,9 m', length: '8,2 m', height: '2,7 m', payload: '54 kg' }
  },
  {
    id: 'c180-skywagon',
    name: 'Cessna 180 Skywagon',
    ...
    description: "Apparu en 1952, il a été conçu pour recevoir de nombreuses modifications comme des flotteurs ou des skis.",
    specs: { wingspan: '10,9 m', length: '7,8 m', height: '2,4 m', payload: '181 kg' }
  },
  {
    id: 'c210-centurion',
    name: 'Cessna 210 Centurion',
    ...
    enginesCount: 1,
    recognitionTips: [
      "Aile haute droite sans haubans",
      "Train d'atterrissage tricycle rétractable",
      "Monomoteur à pistons"
    ],
    description: "Premier avion léger Cessna à posséder un train rentrant. La version pressurisée possède des fenêtres plus petites et plus rondes.",
    specs: { wingspan: '12,4 m', length: '8,6 m', height: '2,9 m', payload: '109 kg' }
  },
  {
    id: 'c303-crusader',
    name: 'Cessna T303 Crusader',
    category: 'Private Light Aircraft',
    role: 'Avion de transport léger',
    manufacturer: 'Cessna',
    country: 'USA',
    engineType: 'Piston',
    enginesCount: 2,
    recognitionTips: [
      "Aile basse et droite",
      "Bimoteur à pistons",
      "Empennage horizontal monté haut (high tail)"
    ],
    description: "Produit entre 1978 et 1987. Il possède un escalier intégré à la porte cargo pour faciliter le chargement de civières.",
    specs: { wingspan: '11,9 m', length: '9,3 m', height: '4,1 m', payload: '267 kg' }
  },
  {
    id: 'c310',
    name: 'Cessna 310',
    ...
    description: "Apparu en 1953, plus de 5 000 unités ont été construites. Les premiers modèles possédaient une dérive droite non en flèche.",
    specs: { wingspan: '11,2 m', length: '9,7 m', height: '3,3 m', payload: '430 kg' }
  }
,
  {
    id: 'c340a',
    ...
    recognitionTips: [
      "Aile basse et droite",
      "Fenêtres de cabine rondes",
      "Fuselage de section circulaire large"
    ],
    description: "Développé à partir du Cessna 310, le 340 possède une cabine pressurisée et plus d'espace interne. Il est conçu pour le marché des navettes d'affaires.",
    specs: { wingspan: '11,6 m', length: '10,5 m', height: '3,8 m', payload: '422 kg' }
  },
  {
    id: 'c401-402-421',
  ...
  },
  {
    ...
    enginesCount: 1,
    recognitionTips: [
      "Aile haute et droite sans haubans",
      "Train d'atterrissage rétractable sur la version RG",
      "Deux fenêtres latérales par côté"
    ],
    description: "Le Cardinal se reconnaît à l'absence de haubans de support d'aile. Il est similaire en apparence au Centurion mais n'a que quatre sièges.",
    specs: { wingspan: '10,8 m', length: '8,3 m', height: '2,6 m', payload: '54 kg' }
  },
  {
    id: 'c-stationair-6',
    name: 'Cessna Stationair 6',
    ...
    description: "Conçu pour le chargement facile de petites palettes et de fret, il peut être configuré pour diverses tâches utilitaires ou pour transporter jusqu'à 8 passagers.",
    specs: { wingspan: '10,9 m', length: '8,6 m', height: '2,8 m', payload: '422 kg' }
  },
  {
    id: 'c-titan',
    name: 'Cessna Titan',
    ...
    recognitionTips: [
      "Aile basse et droite",
      "Fenêtres carrées",
      "Fuselage plus long que le modèle 402"
    ],
    description: "Appelé à l'origine Model 404, le Titan est utilisé principalement comme avion de ligne d'apport. Il transporte deux passagers de plus que le 402.",
    specs: { wingspan: '14,1 m', length: '12 m', height: '4 m', payload: '680 kg' }
  },
  {
    id: 'sr20',
    name: 'Cirrus Design SR-20',
  ...
  },
  {
    ...
    role: 'Avion de sport léger',
    manufacturer: 'Eagle Aircraft',
    country: 'Australie / Malaisie',
    engineType: 'Piston',
    enginesCount: 1,
    recognitionTips: [
      "Aile haute et droite",
      "Plan canard bas et droit (foreplane)",
      "Moteur à pistons unique"
    ],
    description: "Un biplan moderne entièrement construit en matériaux composites. La production a été déplacée d'Australie vers la Malaisie entre 1995 et 1997.",
    specs: { wingspan: '7,2 m', length: '6,5 m', height: '2,3 m', payload: '0 kg' }
  },
  {
    id: 'namcu',
    name: 'ENAER Namcu',
    ...
    recognitionTips: [
      "Aile basse et droite",
      "Cabine surélevée",
      "Conception tout composite"
    ],
    description: "Premier avion ENAER entièrement conçu au Chili. Il répond à un besoin d'avion de club peu coûteux. Il est également assemblé aux Pays-Bas.",
    specs: { wingspan: '8,3 m', length: '7 m', height: '2,4 m', payload: '20 kg' }
  },
  {
    id: 'extra300',
    name: 'Extra 300',
  ...
  },
  {
    ...
    recognitionTips: [
      "Aile basse et droite",
      "Moteur à pistons unique",
      "Aile avec dièdre positif (dihedral wing)"
    ],
    description: "Premier vol en 1965, environ 300 exemplaires ont été construits avant l'arrêt de la production en 1982.",
    specs: { wingspan: '9,4 m', length: '8,2 m', height: '2,6 m', payload: '100 kg' }
  },
  {
    id: 'as202-bravo',
    name: 'FFA AS202 Bravo',
    ...
    description: "Développé en collaboration avec SIAI-Marchetti en Italie. Le Bravo est utilisé par l'école de vol BAe pour l'entraînement élémentaire.",
    specs: { wingspan: '9,7 m', length: '7,5 m', height: '2,8 m', payload: '100 kg' }
  },
  {
    id: 'optica',
    name: 'FLS Optica',
    category: 'Private Light Aircraft',
    role: 'Avion d\'observation léger',
    manufacturer: 'FLS',
    country: 'Royaume-Uni',
    engineType: 'Piston',
    enginesCount: 1,
    recognitionTips: [
      "Aile droite en position médiane",
      "Fuselage à double poutre (twin boom)",
      "Cabine bulle offrant une visibilité exceptionnelle"
    ],
    description: "Conçu pour les tâches de surveillance à basse vitesse. La production a été suspendue suite à l'acquisition par FLS.",
    specs: { wingspan: '12 m', length: '8,2 m', height: '1,9 m', payload: '231 kg' }
  },
  {
    id: 'pinguino',
    name: 'General Avia Pinguino',
    ...
    recognitionTips: [
      "Aile basse et droite",
      "Moteur à pistons unique",
      "Train d'atterrissage rétractable sur certains modèles"
    ],
    description: "Utilisé principalement au niveau des clubs pour l'entraînement de base. Il existe des versions à train fixe (A et B) et à train rétractable (C et R).",
    specs: { wingspan: '9 m', length: '7,4 m', height: '2,8 m', payload: '0 kg' }
  },
  {
    id: 'g115',
    name: 'Grob G115',
  ...
  },
  {
    ...
    recognitionTips: [
      "Aile basse et droite",
      "Biréacteur à pistons",
      "Aile à dièdre positif et empennage horizontal bas"
    ],
    description: "Débuté comme un design Grumman en 1974. Significativement amélioré avant le début de la production en 1977. Utilisé comme entraîneur bimoteur.",
    specs: { wingspan: '11,2 m', length: '9,1 m', height: '3,2 m', payload: 'N/A' }
  },
  {
    id: 'st50',
    name: 'Istravision ST-50',
    category: 'Private Light Aircraft',
    role: 'Avion d\'affaires léger',
    manufacturer: 'Istravision',
    country: 'Israël',
    engineType: 'Piston',
    enginesCount: 1,
    recognitionTips: [
      "Aile basse et droite",
      "Moteur à pistons propulsif unique",
      "Dérive ventrale (ventral tailfin)"
    ],
    description: "Istravision a racheté les droits du Cirrus ST-50. Conception tout composite offrant une structure robuste et de bonnes performances à basse vitesse.",
    specs: { wingspan: '11,9 m', length: '7,9 m', height: '3,6 m', payload: '136 kg' }
  },
  {
    id: 'la250-renegade',
    name: 'Lake La-250 Renegade',
  ...
  },
  {
    ...
    description: "Plus de 400 exemplaires ont été construits depuis 1957. Toujours en service régulier en Europe de l'Est, notamment comme ambulance aérienne.",
    specs: { wingspan: '12,3 m', length: '8,6 m', height: '2,3 m', payload: '135 kg' }
  },
  {
    id: 'mooney-ranger',
    name: 'Mooney Ranger',
    ...
    recognitionTips: [
      "Aile basse et droite",
      "Dérive inversée caractéristique (forward swept tailfin)",
      "Moteur à pistons unique"
    ],
    description: "Mooney a développé de nombreux modèles basés sur le Ranger, tous utilisant la dérive inversée distinctive. 1 860 unités de l'original ont été construites.",
    specs: { wingspan: '11 m', length: '7,5 m', height: '2,5 m', payload: '54 kg' }
  },
  {
    id: 'cap10b',
    name: 'Mudry CAP 10B',
    ...
    enginesCount: 1,
    recognitionTips: [
      "Aile basse droite en flèche",
      "Verrière bulle",
      "Moteur à pistons unique"
    ],
    description: "Le CAP 10B original a été remplacé en production par les monoplaces CAP 231 et 232. De nombreux exemplaires de la Marine française sont désormais civils.",
    specs: { wingspan: '8,1 m', length: '7,2 m', height: '2,6 m', payload: '20 kg' }
  },
  {
    id: 'pa18-supercub',
    name: 'Piper PA-18 Super Cub',
  ...
  },
  {
    ...
    recognitionTips: [
      "Aile haute droite haubanée",
      "Moteur radial unique",
      "Train d'atterrissage en flèche vers l'avant"
    ],
    description: "Près de 1 000 exemplaires construits depuis 1962. Utilisé pour le remorquage de planeurs, le transport, l'ambulance ou la patrouille frontalière.",
    specs: { wingspan: '11,1 m', length: '8,1 m', height: '2,9 m', payload: '35 kg' }
  },
  {
    id: 'b58-baron',
    name: 'Raytheon (Beechcraft) B58 Baron',
  ...
  },
  {
    ...
    description: "Conçu pour le marché de l'entraînement léger. Les premières versions possédaient un empennage bas avant d'adopter la configuration en T.",
    specs: { wingspan: '9,1 m', length: '7,3 m', height: '2,3 m', payload: 'N/A' }
  },
  {
    id: 'atl-club',
    name: 'Robin ATL Club',
  ...
  },
  {
    ...
    recognitionTips: [
      "Aile basse et droite",
      "Empennage horizontal monté à mi-hauteur (mid-tail)",
      "Monomoteur à pistons"
    ],
    description: "Les modèles 112 (210 ch) et 114 (260 ch) ont une apparence externe identique. Ils se distinguent par leur empennage caractéristique.",
    specs: { wingspan: '10,8 m', length: '7,6 m', height: '2,6 m', payload: 'N/A' }
  },
  {
    id: 'tb9-tampico',
    name: 'Socata TB9 Tampico',
  ...
  },
  {
    ...
    description: "Le Rallye a connu de nombreux changements de motorisation. La version armée 'Guerrier' est opérée par le Rwanda et le Sénégal.",
    specs: { wingspan: '9,7 m', length: '7,3 m', height: '2,8 m', payload: '110 kg' }
  },
  {
    id: 'su26',
    name: 'Sukhoi Su-26',
    ...
    description: "Conçu pour la voltige de compétition. Le siège du pilote est incliné à 45 degrés pour mieux contrer les effets de la force G.",
    specs: { wingspan: '7,8 m', length: '6,8 m', height: '2,8 m', payload: 'N/A' }
  },
  {
    id: 'hansa-3',
    name: 'TAAL Hansa 3',
  ...
  },
  {
    ...
    description: "Toute la famille L50 est conçue pour résister à des facteurs de charge de +9g à -6g. La version 50LS est la plus puissante avec 300 ch.",
    specs: { wingspan: '8,6 m', length: '6,6 m', height: '2 m', payload: 'N/A' }
  },
  {
    id: 'zlin-z142',
    name: 'Zlin Z142',
    ...
    recognitionTips: [
      "Aile basse et droite",
      "Aile avec bord d'attaque en flèche",
      "Monomoteur à pistons"
    ],
    description: "Conçu comme entraîneur de voltige, il est aussi utilisé pour le tourisme léger. Plus de 770 appareils ont été construits.",
    specs: { wingspan: '9,1 m', length: '7,1 m', height: '2,7 m', payload: '45 kg' }
  },
  {
    id: 'a109',
    name: 'Agusta A 109',
    ...
    description: "Premier hélicoptère entièrement conçu par Agusta. Les versions militaires possèdent des sièges blindés et des points d'emport externes.",
    specs: { wingspan: '11 m (rotor)', length: '11,4 m', height: '3,5 m', payload: '907 kg' }
  },
  {
    id: 'a129-mangusta',
    name: 'Agusta A 129 Mangusta',
  ...
  },
  {
    ...
    country: 'Italie',
    engineType: 'Turbine',
    enginesCount: 1, // Twinpac groupé
    recognitionTips: [
      "Rotor principal bi-pale (twin rotor)",
      "Patins (skids)",
      "Radar au-dessus du cockpit"
    ],
    description: "Version construite sous licence du Bell UH-1. Agusta l'a modifié pour des rôles embarqués incluant la lutte ASM et la recherche/sauvetage (SAR).",
    specs: { wingspan: '14,7 m (rotor)', length: '12,9 m', height: '4,5 m', payload: '2 270 kg' }
  },
  {
    id: 'a119-koala',
    name: 'Agusta A 119 Koala',
    ...
    recognitionTips: [
      ...
      "Monoturbine",
      "Patins (skids)",
      "Large dérive arrière"
    ],
    description: "Conçu pour offrir le plus grand espace interne pour un hélicoptère monoturbine. Il est entré en production après une phase de tests en 1995.",
    specs: { wingspan: '11 m (rotor)', length: '11,1 m', height: '3,3 m', payload: '1 320 kg' }
  },
  {
    id: 'as61',
    name: 'Agusta/Sikorsky AS-61',
  ...
  },
  {
    ...
    recognitionTips: [
      "Rotor principal bi-pale",
      "Verrière bulle",
      "Poutre de queue en treillis (lattice tail boom)"
    ],
    description: "Rendu célèbre par la série MASH, le Bell 47 a volé pour la première fois en 1947. Il a servi d'ambulance et d'appareil agricole.",
    specs: { wingspan: '11,3 m (rotor)', length: '9,6 m', height: '2,8 m', payload: '455 kg' }
  },
  {
    id: 'jet-ranger',
    name: 'Bell Model 206 JetRanger',
    category: 'Helicopters',
    role: 'Hélicoptère léger',
    manufacturer: 'Bell',
    country: 'USA',
    ...
    description: "Plus de 7 000 exemplaires construits depuis 1971. Ce fut le premier hélicoptère à faire le tour du monde en vol.",
    specs: { wingspan: '10,2 m (rotor)', length: '9,5 m', height: '2,9 m', payload: '635 kg' }
  },
  {
    id: 'long-ranger',
    name: 'Bell Model 206L-4 LongRanger',
    ...
    recognitionTips: [
      ...
      "Monoturbine",
      "Patins (skids)",
      "Trois fenêtres latérales"
    ],
    description: "Version allongée du JetRanger. La cabine a été agrandie pour permettre le transport de deux civières. Souvent utilisé par la police.",
    specs: { wingspan: '11,3 m (rotor)', length: '10,4 m', height: '3,1 m', payload: '1 024 kg' }
  },
  {
    id: 'bell430',
    name: 'Bell Model 430',
    category: 'Helicopters',
    role: 'Hélicoptère de transport VIP',
    manufacturer: 'Bell',
    country: 'USA',
    engineType: 'Turbine',
    enginesCount: 2,
    recognitionTips: [
      "Rotor principal à quatre pales",
      "Double turbine",
      "Train d'atterrissage rétractable ou patins",
      "Pods latéraux"
    ],
    description: "Dernier développement des Bell 222 et 230. Il dispose d'un rotor à quatre pales offrant 10% de puissance supplémentaire.",
    specs: { wingspan: '12,8 m (rotor)', length: '12,8 m', height: '3,5 m', payload: 'N/A' }
  },
  {
    id: 'huey',
    name: 'Bell UH-1 Iroquois (Huey)',
    ...
    recognitionTips: [
      ...
      "Monoturbine",
      "Patins (skids)",
      "Larges portes latérales"
    ],
    description: "Construit en quantités massives entre 1959 et 1987. Dans sa configuration opérationnelle, les troupes sont protégées par des mitrailleurs de porte.",
    specs: { wingspan: '14,6 m (rotor)', length: '17,6 m', height: '4,4 m', payload: '1 759 kg' }
  },
  {
    id: 'twin-huey',
    name: 'Bell UN-1N Iroquois (Twin Huey)',
    category: 'Helicopters',
    role: 'Hélicoptère utilitaire',
    manufacturer: 'Bell',
    country: 'USA',
    ...
    description: "Conçu à l'origine pour le gouvernement canadien. Le Twin Huey a été adopté par l'USMC et l'US Navy. La version 412 possède un rotor à quatre pales.",
    specs: { wingspan: '14,7 m (rotor)', length: '12,9 m', height: '4,5 m', payload: '2 268 kg' }
  },
  {
    id: 'kiowa',
    name: 'Bell OH-58D Kiowa',
    category: 'Helicopters',
    ...
    recognitionTips: [
      ...
      "Monoturbine",
      "Patins (skids)",
      "Viseur monté sur le mât (mast mounted sight)"
    ],
    description: "Développé à partir du JetRanger. Tous les OH-58 de l'US Army sont mis à jour vers le standard Kiowa Warrior avec deux stations d'armement.",
    specs: { wingspan: '10,7 m (rotor)', length: '10,5 m', height: '3,9 m', payload: '907 kg' }
  },
  {
    id: 'cobra',
  ...
  {
    id: 'apache',
    name: 'Boeing (McDonnell Douglas) AH-64 Apache',
    category: 'Helicopters',
    role: 'Hélicoptère d\'attaque',
    manufacturer: 'Boeing',
    country: 'USA',
    ...
    description: "Plus de 1 000 Apache ont été livrés. Le AH-64D possède un radar Longbow monté sur le mât pour communiquer avec les systèmes JSTARS.",
    specs: { wingspan: '14,6 m (rotor)', length: '15,5 m', height: '3,8 m', payload: '1 500 kg' }
  },
  {
    id: 'sea-knight',
    name: 'Boeing CH-46 Sea Knight',
    ...
    enginesCount: 2,
    recognitionTips: [
      "Rotors en tandem (un avant, un arrière)",
      "Double turbine interne",
      "Train d'atterrissage tricycle",
      "Pods latéraux"
    ],
    description: "Connu sous le nom de 'Frog', il est souvent confondu avec le Chinook. Il se distingue par son train tricycle alors que le Chinook a quatre roues.",
    specs: { wingspan: '15,5 m (rotor)', length: '13,7 m', height: '5,1 m', payload: '4 082 kg' }
  },
  {
    id: 'chinook',
    name: 'Boeing CH-47 Chinook',
    ...
    description: "Premier vol en 1961. Il reste le principal transport lourd de nombreuses armées. La version MH-47E est équipée pour les opérations spéciales.",
    specs: { wingspan: '18,3 m (rotor)', length: '15,5 m (fuselage)', height: '5,8 m', payload: '12 210 kg' }
  },
  {
    id: 'defender',
  ...
  {
    id: 'md500e',
    name: 'Boeing (McDonnell Douglas) Model 500E',
    category: 'Helicopters',
    role: 'Hélicoptère léger',
    manufacturer: 'Boeing',
    country: 'USA',
    ...
    description: "Le 500E a remplacé le standard 500 en production en 1982. La cabine a été agrandie et un nouveau moteur installé.",
    specs: { wingspan: '8,1 m (rotor)', length: '7,5 m', height: '2,7 m', payload: '907 kg' }
  },
  {
    id: 'md520',
  ...
  {
    id: 'explorer',
    name: 'Boeing (McDonnell Douglas) Explorer',
    category: 'Helicopters',
    role: 'Hélicoptère utilitaire',
    manufacturer: 'Boeing',
    country: 'USA',
    ...
    description: "Premier hélicoptère conçu spécifiquement pour le système NOTAR. Son design le rend particulièrement adapté aux rôles d'ambulance aérienne en espace confiné.",
    specs: { wingspan: '10,3 m (rotor)', length: '9,7 m', height: '3,6 m', payload: '1 458 kg' }
  },
  {
    id: 'comanche',
    name: 'Boeing/Sikorsky RAH-66 Commanche',
    category: 'Helicopters',
    role: 'Hélicoptère de reconnaissance/attaque',
    ...
    description: "Conçu avec des caractéristiques furtives, son fuselage est fait de matériaux absorbant les radars. Les baies d'armement sont rétractables.",
    specs: { wingspan: '11,9 m (rotor)', length: '13,2 m', height: '3,4 m', payload: '1 185 kg' }
  },
  {
    id: 'brantly-b2',
    name: 'Brantly B-2',
    ...
    description: "Apparu en 1953, le B-2 a été remis en production en 1990 comme entraîneur à bas coût. Il reste présent en nombre, notamment au Japon.",
    specs: { wingspan: '7,2 m (rotor)', length: '6,6 m', height: '2,1 m', payload: '22,7 kg' }
  },
  {
    id: 'rooivalk',
    name: 'Denel (Atlas) Rooivalk',
    ...
    description: "Premier design d'hélicoptère indigène sud-africain (1990). Il utilise la technologie du transport Puma mais avec un fuselage étroit d'attaque.",
    specs: { wingspan: '15,6 m (rotor)', length: '16,4 m', height: '4,6 m', payload: '1 371 kg' }
  },
  {
    id: 'eh101-merlin',
    name: 'EHI EH-101 Merlin',
    ...
    description: "Conçu initialement pour la lutte ASM, il est aussi étudié comme plateforme AEW (alerte précoce) et SAR (sauvetage).",
    specs: { wingspan: '18,6 m (rotor)', length: '22,8 m', height: '6,6 m', payload: '3 900 kg' }
  },
  {
    id: 'eh101-utility',
  ...
  },
  {
    ...
    description: "Utilisé par le Chili, la Colombie et le Pérou pour l'entraînement de base. La version 480 est propulsée par une turbine Allison.",
    specs: { wingspan: '9,7 m (rotor)', length: '8,9 m', height: '2,8 m', payload: '49 kg' }
  },
  {
    id: 'sa330-puma',
  ...
  },
  {
    ...
    description: "Développement étiré du BO 105. L'utilisation de matériaux avancés et du Fenestron a réduit la traînée de 30%.",
    specs: { wingspan: '10,2 m (rotor)', length: '10,2 m', height: '3,6 m', payload: '900 kg' }
  },
  {
    id: 'sa315b-lama',
  ...
  },
  {
    ...
    recognitionTips: [
      "Rotor principal à quatre pales",
      "Poutre de queue haute",
      "Fuselage rond"
    ],
    description: "Premier vol en 1967. Plus de 1 300 appareils ont été construits pour des versions civiles et militaires (antichar PAH-1).",
    specs: { wingspan: '9,8 m (rotor)', length: '8,8 m', height: '3 m', payload: '800 kg' }
  },
  {
    id: 'tiger',
    name: 'Eurocopter Tiger',
    ...
    recognitionTips: [
      "Rotor principal à quatre pales",
      "Cockpits en tandem",
      "Viseur monté sur le mât ou sur le nez"
    ],
    description: "Le pilote est assis à l'avant et le tireur derrière (contrairement à la plupart des hélicoptères d'attaque). Entrée en service prévue en 2003.",
    specs: { wingspan: '13 m (rotor)', length: '14 m', height: '4,3 m', payload: 'Charge militaire' }
  },
  {
    id: 'westland-lynx',
    name: 'GKN Westland Lynx',
  ...
  },
  {
    ...
    recognitionTips: [
      "Rotor principal à quatre pales",
      "Pods latéraux",
      "Poutre de queue haute et plate"
    ],
    description: "Conçu comme hélicoptère polyvalent naval et terrestre. Le programme a été suspendu en 1994 avant d'être relancé.",
    specs: { wingspan: '16,3 m (rotor)', length: '16,1 m', height: '5,4 m', payload: '4 600 kg' }
  },
  {
    id: 'sokol',
    name: 'PZL Swidnik W-3 Sokol',
